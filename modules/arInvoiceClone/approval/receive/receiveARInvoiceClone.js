...
async function loadOutgoingPaymentDetails() {
    try {
        ...
        const response = await fetch(`${BASE_URL}/api/staging-ar-invoice-clone/headers/${docId}`, {
            method: 'GET',
            headers: {
...
async function receiveOPReim() {
    try {
        ...
        const response = await fetch(`${BASE_URL}/api/staging-ar-invoice-clone/approvals/${docId}`, {
            method: 'PUT',
            headers: {
