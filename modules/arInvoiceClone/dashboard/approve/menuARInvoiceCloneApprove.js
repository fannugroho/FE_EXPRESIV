...
async function loadDashboard() {
    try {
        ...
        if (currentTab === 'acknowledged') {
            ...
            baseUrl = `${BASE_URL}/api/staging-ar-invoice-clone/headers`;
...
async function updateCounters(userId) {
    try {
        ...
        const allDocuments = await fetchARInvoiceCloneDocuments('approvedBy', userId, false);
...
async function debugTabFunctionality() {
    ...
    try {
        ...
        const allDocs = await fetchARInvoiceCloneDocuments('approvedBy', userId, false);
