...
function hideButtonsBasedOnStatus(data) {
    ...
    // Hide both buttons if document is already processed
    if (currentStatus === 'Received' || currentStatus === 'Rejected') {
        ...
        // Show buttons if document is ready for receiving
        if (receiveButton) {
...
async function receiveOPReim() {
    try {
        ...
        console.log('📤 Receive Request Data:', requestData);
        ...
        console.log('📥 Receive Response OK:', response.ok);
        ...
        if (!response.ok) {
            ...
            try {
                ...
                console.log('📥 Receive Error Response:', errorData);
            } catch (e) {
        ...
        try {
            ...
            console.log('📥 Receive Success Response:', responseData);
        } catch (e) {
