/**
 * Checker Reimbursement Page - Final Clean Version
...
const Utils = {
    ...
    getCurrentUserInfo() {
        try {
            ...
            return { name: 'Unknown User', role: 'Checker', id: null };
        }
    }
};
...
const ApiService = {
    ...
    async submitRejection(reimId, remarks) {
        return await this.request(`/api/reimbursements/checker/${reimId}/reject`, {
            method: 'PATCH',
    ...
    async submitApproval(reimId) {
        return await this.request(`/api/reimbursements/checker/${reimId}/approve`, {
            method: 'PATCH'
        });
    },
...
const UIManager = {
    ...
    showRejectionRemarks(data) {
        ...
        const rejectionRemarks = data.remarksRejectByChecker ||
...
document.addEventListener('DOMContentLoaded', async function () {
    console.log('=== CHECKER PAGE INITIALIZATION ===');
