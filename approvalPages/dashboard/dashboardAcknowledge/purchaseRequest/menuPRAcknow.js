...
async function downloadExcel() {
    try {
        ...
        XLSX.writeFile(workbook, 'purchase_request_acknowledge_list.xlsx');
    } catch (error) {
...
async function downloadPDF() {
    try {
        ...
        // Menambahkan judul
        doc.setFontSize(16);
        doc.text('Purchase Request Acknowledge Report', 14, 15);
        ...
        // Menyimpan PDF
        doc.save('purchase_request_acknowledge_list.pdf');
    } catch (error) {
