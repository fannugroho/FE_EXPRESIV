...
// Approve (check) the AR invoice reimbursement
async function approveOPReim() {
    try {
        ...
        const requestData = {
            ...
            preparedBy: arInvoiceReimData.approval?.preparedBy || userId,
            checkedBy: userId,
            acknowledgedBy: arInvoiceReimData.approval?.acknowledgedBy || userId,
            approvedBy: arInvoiceReimData.approval?.approvedBy || userId,
            receivedBy: arInvoiceReimData.approval?.receivedBy || userId,
            preparedDate: arInvoiceReimData.approval?.preparedDate || currentDate,
            preparedByName: arInvoiceReimData.approval?.preparedByName || currentUserName,
            checkedByName: currentUserName,
            acknowledgedByName: arInvoiceReimData.approval?.acknowledgedByName || currentUserName,
            approvedByName: arInvoiceReimData.approval?.approvedByName || currentUserName,
            receivedByName: arInvoiceReimData.approval?.receivedByName || currentUserName,
...
async function rejectOPReim() {
    try {
        ...
        await Swal.fire({
            title: 'Success',
            text: 'AR Invoice has been rejected',
            icon: 'success'
        });
...
function validateDocumentStatus() {
    ...
    if (!arInvoiceReimData || !arInvoiceReimData.approval) {
        Swal.fire({
            title: 'Error',
    ...
    const approval = arInvoiceReimData.approval;
