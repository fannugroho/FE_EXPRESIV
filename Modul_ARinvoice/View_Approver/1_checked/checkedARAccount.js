...
function goToMenuAR() {
    window.location.href = '../../../dashboard/dashboardCheck/arInvoice/menuARCheck.html';
}
...
function loadARInvoiceDetails() {
    ...
    // Fetch AR invoice details from API
            fetch(`${BASE_URL}/api/ar-invoices/${arInvoiceId}`, {
        method: 'GET',
        headers: {
...
function approveAR() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch(`${BASE_URL}/api/ar-invoices/${arInvoiceId}/check`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
                    'Content-Type': 'application/json'
...
function rejectAR() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch(`${BASE_URL}/api/ar-invoices/${arInvoiceId}/reject`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
                    'Content-Type': 'application/json'
